  ...
  return (
    <div style={{ backgroundImage: `url(${bgImage})` }} className=" bg-[#E3FFE6] bg-no-repeat bg-cover bg-center">
      ...
      >
        {slides.map((data, i) => (
          <SwiperSlide key={i}>
            <div className="flex items-center justify-between lg:justify-center flex-col lg:flex-row w-full h-full md:h-[700px] lg:h-[730px]">
              <div className="text-left md:text-center lg:text-left w-full space-y-6 px-4 py-5 md:py-2 lg:py-0">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-7xl  font-semibold flex flex-col lg:leading-snug">
