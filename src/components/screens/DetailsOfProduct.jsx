            ...
            <div className="flex flex-col p-5 rounded-2xl bg-red-50 dark:bg-opacity-90">
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M2 14H4" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </div>
              ...
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    strokeLinejoin="round"
                  ></path>
                  <path d="M2 9C2 5.13 5.13 2 9 2L7.95 3.75" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  <path
                    ...
                    strokeLinejoin="round"
                  ></path>
                  <path d="M17.6799 10.82V6.73999" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  <path
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                  ></path>
                  <path d="M6.31995 21.82V17.74" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  <path
              ...
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                  ></path>
                  <path d="M15 3C16.95 8.84 16.95 15.16 15 21" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  <path
              ...
              <div>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    strokeLinejoin="round"
                  ></path>
                  <path d="M12 7.5V16.5" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  <path
                    ...
                    strokeLinejoin="round"
                  ></path>
                  <path d="M17 3V7H21" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                  <path d="M22 2L17 7" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </div>
              <div className="mt-2.5">
