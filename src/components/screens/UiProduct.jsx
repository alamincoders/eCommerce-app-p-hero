  ...
  return (
    <div className="main_card cursor-pointer">
      {showModal ? (
        <div>
          <div className=" justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-[1000] outline-none focus:outline-none ">
            <div className="bg-white rounded-2xl drop-shadow-2xl relative w-auto my-6 mx-auto container py-10 ">
              {/*content*/}
              <QuickView setShowModal={setShowModal} />
            </div>
          </div>
      ...
      <div data-aos="zoom-in-up" className="relative flex-shrink-0 bg-slate-50 dark:bg-slate-300 rounded-3xl overflow-hidden z-1 group ">
        ...
        {/* quick view */}
        {quick_view && (
          <div className="absolute bottom-0 group-hover:bottom-4 inset-x-1 hidden lg:flex justify-center opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all ">
            <Link to="/cart">
