...
const ShareBtn = () => {
  return (
    <div className="sharing-buttons flex flex-wrap">
      <a
        className="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition py-1 px-2 text-sm rounded text-white border-neutral-600 bg-neutral-600 hover:bg-neutral-700 hover:border-neutral-700"
        target="_blank"
        rel="noopener"
