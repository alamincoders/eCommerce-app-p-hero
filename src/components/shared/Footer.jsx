          ...
          <div className="upper grid grid-cols-1  lg:grid-cols-2 gap-4 items-center pb-10 border-b">
            ...
            <div className=" border-none lg:border-l-2 border-gray-200 pl-0 lg:pl-52 ">
              <form onSubmit={handleSubmit} className="space-x-4" action="#">
                ...
                />
                <button type="submit" class="relative inline-block text-lg group mt-5 lg:mt-0">
                  <span class="relative z-10 block px-5 py-2.5 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
