...
const SIgnUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      Swal.fire("Congratulations!", "Successfully, your account has been created!.", "success");
      navigate("/home");
    }, 1000);
  };
  return (
    <div class="min-h-[80vh] bg-gray-100 text-gray-900 flex justify-center">
      <div class="max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          <div>
            <img src={logo} class="w-32 mx-auto" alt="" />
          </div>
              ...
              <form action="#" onSubmit={handleSubmit}>
                <div class="mx-auto max-w-xs">
                  ...
                  <p class="mt-6 text-xs text-gray-600 text-center ">
                    <input required className="align-middle" type="checkbox" name="" id="" /> I agree to abide by Ciseco
