      ...
      >
        ...
        <div className="px-[30px]">
          <div class="mb-4 sm:mb-10 max-w-[140px] mx-auto">
            <img src={step1} class="rounded-3xl" alt="nc-imgs" />
          </div>
        ...
        <div className="px-[30px]">
          <div class="mb-4 sm:mb-10 max-w-[140px] mx-auto">
            <img src={step2} class="rounded-3xl" alt="nc-imgs" />
          </div>

          <div>
            <div class="text-center mt-auto space-y-5">
              <span class="nc-Badge inline-flex px-2.5 py-1 rounded-full font-medium text-xs text-indigo-800 bg-indigo-100  relative">Step 2</span>
        ...
        <div className="px-[30px]">
          <div class="mb-4 sm:mb-10 max-w-[140px] mx-auto">
            <img src={step3} class="rounded-3xl" alt="nc-imgs" />
          </div>
        ...
        <div className="px-[30px]">
          <div class="mb-4 sm:mb-10 max-w-[140px] mx-auto">
            <img src={step4} class="rounded-3xl" alt="nc-imgs" />
          </div>

          <div>
            <div class="text-center mt-auto space-y-5">
              <span class="nc-Badge inline-flex px-2.5 py-1 rounded-full font-medium text-xs text-purple-800 bg-purple-100  relative">Step 4</span>
