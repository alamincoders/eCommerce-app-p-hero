        ...
        <div className=" ml-0 lg:ml-20">
          <div className="flex justify-between items-center">
            ...
            <div className="sharing-buttons flex flex-wrap">
              <a
                class="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition py-1 px-2 text-sm rounded text-white border-zinc-600 bg-zinc-600 hover:bg-zinc-700 hover:border-zinc-700"
                target="_blank"
                rel="noopener"
